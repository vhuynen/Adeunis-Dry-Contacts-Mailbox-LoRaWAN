...
var codec;
(function (codec) {
    var Drycontacts0x10Parser = (function () {
...
var codec;
(function (codec) {
    var Drycontacts0x40Parser = (function () {
...
var codec;
(function (codec) {
    var DrycontactsStatusByteParser = (function () {
...
(function (codec) {
    var Decoder = (function (_super) {
        ...
        function Decoder() {
            ...
            _this.deviceType = 'drycontacts';
            return _this;
        }
        Decoder.prototype.getActiveParsers = function (frameCode) {
            var activeParsers = [];
            var statusByteParsers = new codec.DrycontactsStatusByteParser();
            var dataParser;
            switch (frameCode) {
                case 0x10:
                    dataParser = new codec.Drycontacts0x10Parser();
                    break;
                case 0x40:
                    dataParser = new codec.Drycontacts0x40Parser();
                    break;
                case 0x20:
